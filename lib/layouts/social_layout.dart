    ...
    return BlocConsumer<SocialCubit,SocialState>(builder: (context, state) {
      ...
      condition: SocialCubit.get(context).model != null,
        ...
        bottomNavigationBar: BottomNavigationBar(items: [
          ...
          BottomNavigationBarItem(icon: Icon(IconBroken.Paper_Upload),label: cubit.titles[2]),
          BottomNavigationBarItem(icon: Icon(IconBroken.Location),label: cubit.titles[3]),
          BottomNavigationBarItem(icon: Icon(IconBroken.Setting),label: cubit.titles[4]),
        ],
